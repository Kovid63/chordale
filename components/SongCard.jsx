        ...
        <div className={styles.container}>
            <div className={styles.card}>
                ...
                <div className='flex flex-row h-full w-4/12 justify-between items-center'>
                    <p className='font-body text-white/60 text-[10px]'>00:00</p>
                    <div className='relative mt-1 w-8/12'>
                        <Slider sx={{
                            ...
                            aria-label="time-indicator" size="small" value={position} min={0} step={1} max={200} onChange={(_, value) => setPosition(value)} />
                    </div>
                    <p className='font-body text-white/60 text-[10px]'>{position}</p>
                </div>

                {/* shuffle, loop */}
                <div className='flex px-10 justify-between flex-row h-full w-1/5 items-center'>
                    <svg className='h-5 ml-1' viewBox="0 0 230.055 230.055">
                    ...
                    <svg className='h-5' viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
